...
import Hero from '@/components/custom-ui/Hero';
import LoadingCharacters from '@/components/custom-ui/characters/loaders/LoadingCharacters';
import CharactersNoPagination from '@/components/custom-ui/characters/CharactersNoPagination';
import PaginationToggle from '@/components/custom-ui/characters/PaginationToggle';
        ...
        >
            ...
            {withPagination === true ?
                <Suspense
                    ...
                    fallback={<LoadingCharacters howMany={CHARACTERS_PER_PAGE} />}
                >
                    <Characters
                ...
                <Suspense
                    ...
                    fallback={<LoadingCharacters howMany={8} />}
                >
